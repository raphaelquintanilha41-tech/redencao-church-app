  ...
  if (sent) {
    return (
      <div className="static-screen caminhada-confirm">
        <div className="caminhada-confirm-icon">✓</div>
        <h2 className="igreja-title">Pedido enviado</h2>
  ...
  return (
    <div className="static-screen">
      <header className="igreja-header">
        ...
        <h1 className="igreja-title">Preciso de oração</h1>
      </header>
      <section className="card perfil-section">
        <h3 className="home-section-title">Categoria</h3>
      ...
      <section className="card perfil-section">
        <h3 className="home-section-title">Seu pedido</h3>
        <textarea
