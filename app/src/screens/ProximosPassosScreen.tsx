  ...
  return (
    <div className="static-screen">
      <header className="igreja-header">
        ...
        <h1 className="igreja-title">Próximos passos</h1>
      </header>
      {steps.map((step) => (
        <section key={step.n} className="card caminhada-step-card">
          <div className="caminhada-step-number">{step.n}</div>
          <div className="caminhada-step-body">
            <div className="home-plan-title">{step.title}</div>
            <p className="static-body-text">{step.description}</p>
          </div>
